...
#ifndef TT_MN_SV_SYNC_MAIN_H_
#define TT_MN_SV_SYNC_MAIN_H_
...
class tt_mn_svSyncMain {
public:


	static tt_mn_svSyncMain& getInstance()
	{
		static tt_mn_svSyncMain instance;
