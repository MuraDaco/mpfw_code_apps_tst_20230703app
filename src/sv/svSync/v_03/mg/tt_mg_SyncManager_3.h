...
//  *******************************************************************************
/*
 * tt_mg_SyncManager_3.h
 *
 *  Created on: Oct,  4 2022
 *      Author: Marco Dau
 */

#ifndef TT_MG_SYNC_MANAGER_3_H_
#define TT_MG_SYNC_MANAGER_3_H_
...
class tt_mg_SyncManager_3 {
public:

	static tt_mg_SyncManager_3& getInstance()
	{
		static tt_mg_SyncManager_3 instance;
